...
namespace CodeCake
{
    ...
    public class Build : CodeCakeHost
    {
        public Build()
        {
            ...
            const string solutionName = "CK-ActivityMonitor-ApplicationInsights";
            ...
            Task("Push-NuGet-Packages")
                ...
                .Does(() =>
                {
                    ...
                    PushNuGetPackages( "MYGET_API_KEY", "https://www.myget.org/F/bcrosnier/api/v2/package", nugetPackages );
                    /*
                    if (gitInfo.IsValidRelease)
                    {
